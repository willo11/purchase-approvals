# Approver Flow — Delta Spec

Delta for the `approver-flow` capability (main spec: `openspec/specs/approver-flow/spec.md`). All requirements below are ADDED by this change.
