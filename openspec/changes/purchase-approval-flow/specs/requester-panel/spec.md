# Requester Panel — Delta Spec

Delta for the `requester-panel` capability (main spec: `openspec/specs/requester-panel/spec.md`). All requirements below are ADDED by this change.
